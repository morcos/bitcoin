...
'''
This test is meant to exercise BIP112 (CHECKSEQUENCEVERIFY) activation
...
class BIP112Test(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Test 5
        # Check that the new CSV rules are not enforced
        ...
        # Test 6
        # Check that the new CSV rules are enforced
